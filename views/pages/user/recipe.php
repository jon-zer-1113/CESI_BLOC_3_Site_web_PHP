...
<section class="user__recipe-page text-center">
    ...
    <article class="current-recipe" id="content">
        ...
        <article class="recipe-general-information my-5">
            ...
            <div class="container-fluid">
                <div class="container d-flex justify-content-center pt-5 pb-3">
                    ...
                    <p class="mx-5"><i class="fa-solid fa-plus-minus"></i> <?= htmlspecialchars($this->recipe['difficulty'], ENT_COMPAT) ?></p>
        ...
        <article class="mb-5">
            <h4>Télécharger la recette</h4>
            <button type="button" id="downloading-btn-recipe" class="btn btn-danger text-uppercase mt-2">Clique-ici</button>
        </article>
    ...
    <article class="form-comment">
        ...
        <form action="index.php?p=nouveau-commentaire" class="needs-validation mt-2 py-5 mx-auto" method="POST" novalidate>
            <div class="mb-3 mx-auto">
                ...
                <input type="text" class="form-control mx-auto" name="commentTitle" id="comment-title" required>
            ...
            <div class="mb-3 mx-auto">
                ...
                <textarea name="content" class="form-control mx-auto" rows="10" id="comment-content" required></textarea>
            ...
            <div class="modal-body text-center">
                <form action="#" method="POST">
                    <div class="form-group mb-5">
                        <label for="writing-shopping-list">Rédige ton email ✏️</label>
