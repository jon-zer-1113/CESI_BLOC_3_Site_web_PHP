                        ...
                        <?php foreach ($this->recipes as $recipe) : ?>
                            <tr>
                                ...
                                <td class="d-flex flex-column align-items-center">
                                    ...
                                    <a href="index.php?p=supprimer-recette&recipeId=<?= htmlspecialchars($recipe['recipeId']) ?>" class="btn btn-danger mb-3" onclick="return confirm('Es-tu sur de vouloir supprimer cette recette ? 🍔')" title="Supprimer"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
