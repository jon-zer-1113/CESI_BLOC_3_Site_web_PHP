...
<section class="back-office__all-recipes-page">
    <h1 class="text-center">Comptes utilisateurs</h1>

    <article class="text-center">
        <h2 class="mt-3 mb-5">Consulte les utilisateurs</h2>
        <h3>Check les comptes existants !</h3>
        <p class="mt-4 mb-5 mx-auto">Voici la liste de l'ensemble des utilisateurs actuels. <span>La gestion est réservé au compte super administrateur.</span></p>
    </article>
