...
<section class="back-office__all-users-page">
    ...
    <article class="text-center">
        ...
        <p class="mt-4 mb-5 mx-auto">Voici la liste de l'ensemble des utilisateurs actuels. <span>La suppression de comptes est réservé au compte superAdmin.</span></p>
    </article>
