...
class Validate {
    ...
    private function postNewComment($commentTitle, $content, $title, $username, $userId, $recipeId)
    {
    ...
    private function validationCurrentComment($commentTitle, $content, $title, $username, $userId, $recipeId)
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (empty($commentTitle) || empty($content) || empty($title) || empty($username) || empty($userId) || empty($recipeId)) {
                exit("Un ou plusieurs champ(s) vide(s) ⚠️");
            } else {
                return true;
            }
    ...
    public function validationNewComment($commentTitle, $content, $title, $username, $userId, $recipeId)
    {
        $this->postNewComment($commentTitle, $content, $title, $username, $userId, $recipeId);
        $this->validationCurrentComment($commentTitle, $content, $title, $username, $userId, $recipeId);
    }
